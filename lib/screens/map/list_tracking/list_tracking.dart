...
// class ListTrackingPage extends StatefulWidget {
//   final String title;
//   final List<EmployeeTrackingModel> list;
//   final EmployeeTrackingModel item;
//   ListTrackingPage({Key key, this.title, this.list, this.item})
//       : super(key: key);
...
// class _MyHomePageState extends State<ListTrackingPage> with AfterLayoutMixin {
...
//         if (item.makerId.contains(query)) {
