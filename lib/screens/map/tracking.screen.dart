...
// import 'package:athena/screens/map/list_tracking/list_tracking.dart';
...
//   TrackingMapScreen({Key key}) : super(key: key);
...
//       new GlobalKey<ScaffoldState>(debugLabel: 'TrackingMapScreenState');
...
//     if (radius == '' || radius == null || int.tryParse(radius) <= 0) {
...
//       if (Utils.checkIsNotNull(newPos)) {
...
//             .elementAt(index)
//             .coordinates;
//         var _location = new LatLng(double.tryParse(location.latitude),
...
//           // _mapProvider.lstEmployeeTrackingModel.elementAt(index).location = location;
//           _markers.add(Marker(
//               onTap: () async {
//                 changeInfoCustomer(
//                     this._mapProvider.lstEmployeeTrackingModel.elementAt(index),
...
//       context: context,
//       builder: (context) =>
//           ListTrackingPage(title: title, list: list, item: item),
//     );
...
//   switchPosition(EmployeeTrackingModel detail) {
//     var location = detail.coordinates;
//     var _location = new LatLng(double.tryParse(location.latitude),
//         double.tryParse(location.longitude));
//     _mapController.animateCamera(CameraUpdate.newLatLng(
//         LatLng(_location.latitude, _location.longitude)));
//     _mapController.showMarkerInfoWindow(MarkerId(detail.makerId.toString()));
//     currentNode = detail;
//     setState(() {});
//   }
...
//     _mapController.animateCamera(CameraUpdate.newLatLng(
//         LatLng(_location.latitude, _location.longitude)));
//     _mapController.showMarkerInfoWindow(MarkerId(this
//         ._mapProvider
//         .lstEmployeeTrackingModel
//         .elementAt(this.currentIndex)
//         .makerId
