...
class VietMapScreenPosition extends StatefulWidget {
  VietMapScreenPosition({Key? key}) : super(key: key);
  @override
  _MapScreenPositionState createState() => _MapScreenPositionState();
}

class _MapScreenPositionState extends State<VietMapScreenPosition>
