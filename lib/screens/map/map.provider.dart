...
//   int currentPage = 1;
//   int countBacklog = 0;
//   int dateFrom = DateTime.now().microsecondsSinceEpoch;
//   int dateTo = DateTime.now().microsecondsSinceEpoch;
...
//   set setLstCollectionDetailModel(List lstCollectionDetailModel) =>
